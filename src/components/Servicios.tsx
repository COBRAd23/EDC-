...
const services = [
  {
    ...
    desc: "Evaluaciones de riesgo, inventarios, planes de manejo y dictámenes técnicos.",
    bullets: [
      "Asesoramiento Técnico.",
      "Gestión y manejo de riesgos, plantaciones.",
      "Tratamiento Fitosanitarios.",
    ],
    image: "/img/palmera.webp",
  },
  {
    icon: Scissors,
    tag: "02 — Intervenciones",
    title: "Poda de altura.",
    desc: "Poda formativa, sanitaria y de seguridad. Limpieza técnica de palmeras y tratamientos de conservación.",
    bullets: [
