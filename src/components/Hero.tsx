...
const Hero = () => {
  ...
  return (
    <section ref={ref} id="home" className="relative min-h-screen overflow-hidden flex items-center pt-24">
      ...
      <motion.div style={{ opacity }} className="container relative w-full">
        ...
        <div className="grid lg:grid-cols-2 items-center gap-8">
          ...
          >
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-bold leading-[1.05] mb-8">
          ...
          {/* Columna imagen — solo visible en lg+ */}
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            className="hidden lg:flex justify-center items-end self-end"
          >
            <img
              src="/img/isologo_grande%20header.png"
              alt="Isologo EDC Arborismo"
              className="w-full max-w-[420px] xl:max-w-[520px] 2xl:max-w-[620px] h-auto opacity-90 drop-shadow-[0_0_40px_rgba(132,204,22,0.2)]"
              loading="eager"
            />
          </motion.div>
