...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ opacity }} className="container relative w-full py-28 lg:py-0">
        <div className="grid lg:grid-cols-2 lg:min-h-screen lg:items-center gap-6 lg:gap-8">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-3 py-1.5 mb-5 backdrop-blur-sm w-fit">
              <TreePine className="size-3.5 text-primary" />
              <span className="text-[10px] lg:text-xs font-medium tracking-widest uppercase text-primary">
                Arboricultura Técnica · ISA Certified
              </span>
            </div>

            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.05] mb-5 lg:mb-8">
              Soluciones Integrales en{" "}
              <span className="text-gradient-green">Arboricultura</span> y{" "}
              <span className="italic font-light">Poda de Altura</span>
            </h1>

            <p className="text-base lg:text-lg xl:text-xl text-muted-foreground max-w-2xl mb-7 lg:mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4">
              <Button variant="hero" size="lg" asChild className="lg:h-14 lg:px-8 lg:text-base">
                <a href="#contacto">
                  Solicitar Presupuesto <ArrowRight className="size-4 lg:size-5" />
                </a>
              </Button>
              <Button variant="glow" size="lg" asChild className="lg:h-14 lg:px-8 lg:text-base">
                <Link to="/portfolio">Ver Trabajos</Link>
              </Button>
            </div>

            <div className="mt-10 lg:mt-16 grid grid-cols-3 gap-6 max-w-sm lg:max-w-xl">
              {[
          ...
          >
            <img
              ...
              className="w-full max-w-[400px] xl:max-w-[500px] 2xl:max-w-[620px] h-auto opacity-90 drop-shadow-[0_0_40px_rgba(132,204,22,0.2)] translate-y-[1px]"
              loading="eager"
            />
          </motion.div>
